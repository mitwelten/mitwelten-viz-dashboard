  ...
  return (
    <>
      ...
      >
        <InfoPanelHeader
          collapsed={collapsed}
          onIconClick={() => setCollapsed(!collapsed)}
        >
          Mitwelten
        </InfoPanelHeader>
        <InfoPanelContent>
          <h5 style={{ color: 'black', marginTop: 0 }}>
            Wie können mediale Designin­terventionen auf Grundlage des Internets
            der Dinge ökologisch und kulturell zur Förderung von Biodiversität
            in lokalen Ökosystemen beitragen?
          </h5>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              Hochschule für Gestaltung und Kunst und Technische Hochschule, mit
              SWILD – Stadtökologie Wildtierforschung Kommunikation (non-profit
              Forschungs- und Beratungsgemeinschaft)
            </li>
            <li>
          ...
          <p>
            ...
            medienwissenschaftlich erweiterte, interdisziplinäre Designforschung
            und Technologie-Entwicklung Verfahren und Mittel zur Bewahrung der
            Artenvielfalt in Siedlungs- und Naherholungsgebieten zu entwickeln
          ...
          <p>
            Die Verhaltensweisen, Anforderungen und ökologischen Leistungen der
            verschiedenen lokalen Akteure – Menschen, Tiere, Pflanzen, Dinge und
            Technologien sowie Landschaftselemente und Infrastrukturen – werden
            untersucht, Zusammenhänge analysiert und bedarfsgerechte
            Gestaltungsentwürfe für geteilte Lebensräume entwickelt.
          </p>
          <p>
            Mit sensorbasierten Installationen wird direkt im Feld erprobt, wie
            ökologische Wissensbestände und Erfahrungen erweitert werden können,
            um Pflanzen und Tieren im gesellschaftlichen Bewusstsein angemessen
            Gehör zu verschaffen. Anpassungsfähige, an Bedarf und Eigenheiten
            der örtlichen Flora und Fauna orientierte Infrastrukturen ersetzen
            auf Industrie, Auto und ausschiesslich auf den Menschen bezogene
            Bebauungsformen und fördern ökologische Werte und Verhaltensweisen.
            Dazu wird ein Internet of Things Toolkit entwickelt, das im Rahmen
            der gestalterischen Interventionen als medientechnologische
            Infrastruktur dient. Der Einsatz von Technologie erfolgt aber in
            kritischer Abgrenzung von kommerziellen und technophilen ‘smarten’
            Produkten und Systemen – so zurückhaltend und transparent wie
            möglich, so durchdacht und konsequent wie nötig.
          </p>
          <p>
            <img
          ...
          <p>
            ...
            können Wildtieren mittlerweile attraktivere Lebensgrundlagen als die
            Agrarwüsten der industriellen Landwirtschaft bieten, wodurch es zu
            Konflikten kommt. Bisher werden Grünanlagen in der
            ...
            gesellschaftlich engagierten interdisziplinären Zusammenarbeit bei.
          </p>
        </InfoPanelContent>
      </div>
